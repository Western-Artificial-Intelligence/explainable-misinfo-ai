...
const backendProxyTarget = process.env.VITE_API_PROXY_TARGET || "http://127.0.0.1:8000";
...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      "/classify": { target: backendProxyTarget, changeOrigin: true },
      "/predict": { target: backendProxyTarget, changeOrigin: true },
