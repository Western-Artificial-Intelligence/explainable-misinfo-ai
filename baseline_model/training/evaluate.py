"""
Evaluate a saved checkpoint on the test set and save metrics to JSON.
"""
...
def evaluate_checkpoint(checkpoint_path: str, config: dict, device: str = "cpu"):
    """
    Load a model checkpoint and run evaluation on the 'test' split.
    ...
    Returns:
        results dict containing basic metrics and ECE
    """
