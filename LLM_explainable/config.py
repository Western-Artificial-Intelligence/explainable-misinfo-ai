...
def load_config_from_env() -> AppConfig:
    ...
    rag = RAGConfig(
        ...
        user_agent=_env("RAG_USER_AGENT", "verifier_pipeline/1.0 (+https://example.invalid)") or
                  "verifier_pipeline/1.0 (+https://example.invalid)",
    )
    ...
    generator = GeneratorConfig(
        ...
        ollama_url=_env("GEN_OLLAMA_URL", "http://localhost:11434/api/generate") or
                   "http://localhost:11434/api/generate",
        llamacpp_url=_env("GEN_LLAMACPP_URL", "http://localhost:8080/completion") or
                     "http://localhost:8080/completion",
        vllm_url=_env("GEN_VLLM_URL", "http://localhost:8000/v1/chat/completions") or
